        ...
        <div className="container mx-auto px-4 md:px-8 py-12">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Hotline WA: 0857 3979 9999 | Telepon: (0274) 583631
                </p>
              </div>
            </div>
            <Link
                    ...
                    <div className="p-4 space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="text-center flex-1">
                          ...
                          <p className="text-[#2FA4A9] font-bold text-base">
                            {item.childPrice}
                          </p>
                        </div>
                        ...
                        <div className="text-center flex-1">
                          ...
                          <p className="text-[#F5A721] font-bold text-base">
                            {item.adultPrice}
                          </p>
                        </div>
                      </div>
                      {item.note && (
                        <p className="text-xs text-gray-400 bg-gray-50 rounded px-2 py-1.5 leading-relaxed flex items-start gap-1">
                          <Info className="w-3.5 h-3.5 shrink-0 mt-0.5 text-[#2FA4A9]" />{" "}
                          {item.note}
                        </p>
                      )}
                    </div>
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {programKreativitas.map((item) => (
                ...
                >
                  ...
                  <div className="p-4">
                    <p className="text-2xl font-bold text-[#F5A721] mb-2">
                      {item.price}
                    </p>
                    {item.note && (
                      <p className="text-xs text-gray-400 bg-gray-50 rounded px-2 py-1.5 leading-relaxed flex items-start gap-1">
                        <Info className="w-3.5 h-3.5 shrink-0 mt-0.5 text-[#F5A721]" />{" "}
                        {item.note}
                      </p>
                    )}
                  </div>
            ...
            <div className="mt-4 bg-[#FFF8EC] border border-[#F5A721]/30 rounded-md p-4 text-sm text-gray-600 flex gap-3">
              ...
              <p>
                Area Playground: Kampung Kerajinan (Lokasi untuk semua program
                kreativitas)
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-md border border-gray-100 shadow-sm p-6 md:p-8">
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-xl font-bold text-gray-800">
                Prosedur Kunjungan Rombongan Sekolah
              </h2>
            </div>
