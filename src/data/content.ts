...
export const wahanaList: Wahana[] = [
  ...
  },
  {
    ...
    category: "Playground",
    img: "/images/assets/playground.jpg",
  ...
  },
  {
    ...
    img: "/images/assets/kampung-kerajinan.jpg",
  ...
  },
  {
    ...
    category: "Indoor",
    img: "/images/assets/gedung-paud.jpg",
  ...
  },
  {
    ...
    category: "Indoor",
    img: "/images/assets/planetarius.jpg",
  ...
  },
  {
    ...
    category: "Indoor",
    img: "/images/assets/gedung-kotak.jpg",
  ...
  },
  {
    ...
    category: "Indoor",
    img: "/images/assets/gedung-oval.jpg",
  ...
  },
  {
    ...
    category: "Indoor",
    img: "/images/assets/bg-depan.jpg",
...
export const beritaList: Berita[] = [
  {
    ...
    excerpt: "Form Pendaftaran dan Juknis kontes Robot Pintar Yogyakarta (KRPY) 2025 dapat diakses di link berikut https://linktr.ee/InspireKRPY2025 ...",
  ...
  },
  {
    ...
    excerpt: "Taman Pintar Yogyakarta kembali menghadirkan Kontes Roket Air Taman Pintar 2025 yang akan berlangsung di Taman Budaya Embung Giwangan.",
  ...
  },
  {
    ...
    excerpt: "Pendaftaran peserta melalui link berikut: https://bit.ly/kontesroketairtp2025",
  ...
  },
  {
    ...
    excerpt: "Taman Budaya Embung Giwangan (TBEG) hadir dengan kegiatan Pasar Minggu yang kreatif dan menyenangkan.",
  ...
  },
  {
    ...
    excerpt: "Taman Pintar menyelenggarakan program pelatihan keamanan siber dan literasi digital untuk pelajar.",
  ...
  },
  {
    ...
    excerpt: "Kompetisi bergengsi tingkat nasional mempertemukan para pelajar terbaik dari seluruh Indonesia.",
  ...
  },
  {
    ...
    excerpt: "Taman Budaya Embung Giwangan resmi dibuka sebagai ruang publik baru yang menggabungkan seni, budaya, dan olahraga.",
  ...
  },
  {
    ...
    excerpt: "Sambut libur Lebaran 2025 dengan berbagai program dan wahana spesial yang telah disiapkan.",
...
export const galeriItems: GaleriItem[] = [
  { id: 1, alt: "Gedung Oval Taman Pintar", category: "Fasilitas", img: "/images/assets/gedung-oval.jpg", size: "tall" },
  { id: 2, alt: "Pengunjung Taman Pintar", category: "Kegiatan", img: "/images/assets/bg-depan.jpg", size: "normal" },
  { id: 3, alt: "Wahana Bahari", category: "Wahana", img: "/images/assets/wahana-bahari.jpg", size: "normal" },
  { id: 4, alt: "Kontes Robot Pintar", category: "Event", img: "/images/assets/gedung-kotak.jpg", size: "wide" },
  { id: 5, alt: "Planetarium Taman Pintar", category: "Wahana", img: "/images/assets/planetarius.jpg", size: "tall" },
  { id: 6, alt: "Kegiatan Kreasi Batik", category: "Kegiatan", img: "/images/assets/kampung-kerajinan.jpg", size: "normal" },
  { id: 7, alt: "Playground Taman Pintar", category: "Wahana", img: "/images/assets/playground.jpg", size: "normal" },
  { id: 8, alt: "Gedung Kotak Taman Pintar", category: "Fasilitas", img: "/images/assets/gedung-kotak.jpg", size: "normal" },
  { id: 9, alt: "Pameran Sains", category: "Event", img: "/images/assets/bg-depan.jpg", size: "wide" },
  { id: 10, alt: "Dino Adventure", category: "Wahana", img: "/images/assets/gedung-paud.jpg", size: "tall" },
  { id: 11, alt: "Kreasi Gerabah", category: "Kegiatan", img: "/images/assets/kampung-kerajinan.jpg", size: "normal" },
  { id: 12, alt: "Area Playground", category: "Fasilitas", img: "/images/assets/playground.jpg", size: "normal" },
  { id: 13, alt: "Hand On Science", category: "Wahana", img: "/images/assets/zona-perpus.jpg", size: "normal" },
  { id: 14, alt: "Kontes Roket Air", category: "Event", img: "/images/assets/zona-sampah.jpg", size: "normal" },
  { id: 15, alt: "Kampung Kerajinan", category: "Kegiatan", img: "/images/assets/kampung-kerajinan.jpg", size: "tall" },
];
